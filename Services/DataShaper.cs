...
namespace Services
{
    ...
    {
        public PropertyInfo[] Properties { get; set; } //çalışma zamanında bize gerekli olan nesnenin ınfolarını alacak
        public DataShaper()
        {
        ...
        private IEnumerable<PropertyInfo> GetRequiredProperties(string fieldsString)
        {
            ...
            if(!string.IsNullOrWhiteSpace(fieldsString)) 
            {
                var fields=fieldsString.Split(',',
                    StringSplitOptions.RemoveEmptyEntries); //virgülle ayır
            ...
            {
                requiredFields=Properties.ToList();//Datashaping yoksa dön
            }
